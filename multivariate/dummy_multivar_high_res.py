...
rain = pd.read_csv('tsvalues_long_synth_high_res.csv')


#cut rows to match simulation
n_rain = rain.shape[0]

rain = rain[13:n_rain-2]

#rain.drop(columns = ['#Timestamp'], inplace = True)
rain.drop(columns = ['X.Timestamp'], inplace = True) #for synth

swmm = pd.read_csv('pyswmm_multi_var_synth_high_res.csv')
...
#extract every 2nd element from y_pred, y_test
...
print(y_test.shape)
print(y_test.head())
date_time_test = date_time_test[0::2]
