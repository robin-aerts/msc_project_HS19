...
forecast_steps = 3
swmm['level_1'] = swmm['level_1'].shift(-forecast_steps)
swmm['level_2'] = swmm['level_2'].shift(-forecast_steps)
swmm['level_3'] = swmm['level_3'].shift(-forecast_steps)

swmm=swmm.iloc[0:-forecast_steps]
rain = rain.iloc[0:-forecast_steps]
...
date_time_test = date_time.iloc[n_train:-forecast_steps]
