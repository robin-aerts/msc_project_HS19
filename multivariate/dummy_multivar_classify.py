...
over_level = 0.5
design_df['level_1'] = (design_df['level_1'] > over_level).astype(int)
design_df['level_2'] = (design_df['level_2'] > over_level).astype(int)
design_df['level_3'] = (design_df['level_3'] > over_level).astype(int)
...
def build_model(n_nodes):
  model = keras.Sequential([
    ...
    layers.Dense(nlabel, activation='softmax')
  ])
...
def eval_multivar(y_test, y_pred, manhole_str):
  ...
  ax_1.plot(date_time_test, y_pred, label = 'Flooding Probability ANN')
  ax_1.plot(date_time_test, y_test, label = 'Manhole Flooding SWMM')
  ax_1.set_ylabel('Manhole Flooding')
  ax_1.legend()
  fig_1.autofmt_xdate()
  plt.show()
  ...
  ax_2.set_xlabel('Flooding Probability ANN')
  ax_2.set_ylabel('Manhole Flooding SWMM [m]')
  plt.show()
...
over_level = 0.5
f1_1 = f1_score(y_test_1 > over_level, y_pred_1 > over_level)
f1_2 = f1_score(y_test_2 > over_level, y_pred_2 > over_level)
f1_3 = f1_score(y_test_3 > over_level, y_pred_3 > over_level)
print(f1_1)
print(f1_2)
print(f1_3)
