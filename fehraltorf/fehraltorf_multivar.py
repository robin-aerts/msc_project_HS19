...
swmm = pd.read_csv('df_table.csv')
swmm.columns = ['date_time', 'level_1', 'level_2', 'level_3', 'level_4']
print(swmm.head())
print(swmm.shape)
...
swmm = pd.read_csv('df_table_special_structures.csv')
swmm.columns = ['date_time', 'level_1', 'level_2', 'level_3', 'level_4']
print(swmm.shape)
...
eval_4 = eval_multivar(y_test_4, y_pred_4, 'eval_4')
...
plot_event(y_test_4, y_pred_4, 'eval_4')
...
evaluate_classification(y_test_3, y_pred_3, over_level = 1)
evaluate_classification(y_test_4, y_pred_4, over_level = 0.01)
